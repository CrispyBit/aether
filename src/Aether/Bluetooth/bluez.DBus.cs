...
namespace bluez.DBus
{
    ...
    interface IHealthManager1 : IDBusObject
    {
    ...
    class GattCharacteristic1Properties
    {
        ...
        private ObjectPath[] _Descriptors = default(ObjectPath[]);
        public ObjectPath[] Descriptors
        {
            get
            {
                return _Descriptors;
    ...
    static class GattCharacteristic1Extensions
    {
        ...
        public static Task<ObjectPath[]> GetDescriptorsAsync(this IGattCharacteristic1 o) => o.GetAsync<ObjectPath[]>("Descriptors");
    }
    ...
    class Device1Properties
    {
        ...
        private ObjectPath[] _GattServices = default(ObjectPath[]);
        public ObjectPath[] GattServices
        {
            get
            {
                return _GattServices;
            }
    ...
    static class Device1Extensions
    {
        ...
        public static Task<ObjectPath[]> GetGattServicesAsync(this IDevice1 o) => o.GetAsync<ObjectPath[]>("GattServices");
    ...
    [DBusInterface("org.bluez.ProximityReporter1")]
    interface IProximityReporter1 : IDBusObject
    {
        Task<T> GetAsync<T>(string prop);
        Task<ProximityReporter1Properties> GetAllAsync();
        Task SetAsync(string prop, object val);
        Task<IDisposable> WatchPropertiesAsync(Action<PropertyChanges> handler);
    }

    [Dictionary]
    class ProximityReporter1Properties
    {
        private string _LinkLossAlertLevel = default(string);
        public string LinkLossAlertLevel
        {
            get
            {
                return _LinkLossAlertLevel;
            }

            set
            {
                _LinkLossAlertLevel = (value);
            }
        }

        private string _ImmediateAlertLevel = default(string);
        public string ImmediateAlertLevel
        {
            get
            {
                return _ImmediateAlertLevel;
            }

            set
            {
                _ImmediateAlertLevel = (value);
            }
        }
    }

    static class ProximityReporter1Extensions
    {
        public static Task<string> GetLinkLossAlertLevelAsync(this IProximityReporter1 o) => o.GetAsync<string>("LinkLossAlertLevel");
        public static Task<string> GetImmediateAlertLevelAsync(this IProximityReporter1 o) => o.GetAsync<string>("ImmediateAlertLevel");
    }
